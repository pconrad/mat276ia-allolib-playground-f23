...
class SineEnv : public SynthVoice {
 public:
  ...
  void init() override {
    ...
    createInternalTriggerParameter("attackTime", 0.01, 0.01, 2.0);
    createInternalTriggerParameter("decayTime", 0.01, 0.01, 2.0);
    createInternalTriggerParameter("releaseTime", 1.0, 0.1, 3.0);
